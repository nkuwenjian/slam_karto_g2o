...
SlamKartoG2o::SlamKartoG2o() {
  ...
  ss_ = node_.advertiseService("dynamic_map", &SlamKartoG2o::mapCallback, this);
  scan_filter_sub_ =
  ...
  scan_filter_->registerCallback(
      boost::bind(&SlamKartoG2o::laserCallback, this, _1));
  ...
  transform_thread_ = std::make_unique<boost::thread>(
      boost::bind(&SlamKartoG2o::publishLoop, this, transform_publish_period));
...
karto::LaserRangeFinder* SlamKartoG2o::getLaser(
    const sensor_msgs::LaserScan::ConstPtr& scan) {
...
bool SlamKartoG2o::addScan(karto::LaserRangeFinder* laser,
                           const sensor_msgs::LaserScan::ConstPtr& scan,
                           karto::Pose2* karto_pose) {
